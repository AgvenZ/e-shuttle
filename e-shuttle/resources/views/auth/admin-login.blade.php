    ...
    <div class="max-w-md w-full">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-6">
            ...
            <form method="POST" action="{{ route('admin.login.submit') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" required
                           class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600 focus:border-transparent dark:bg-gray-700 dark:text-white"
            ...
            <div class="text-center mt-4">
                <a href="{{ route('welcome') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors duration-200">
